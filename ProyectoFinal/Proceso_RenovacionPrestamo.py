...
if __name__ == '__main__': 
    ...
    # Register process
    register_message = 'registro,renovacion,' + branch + ',' + pub_load_manager_address + ',' + pub_coordinator_address
    response = ''
    while response != 'ok': 
    ...
    request_message = 'peticion,renovacion,' + branch + ',' + 'coordinador:rep_processes_address,' + 'gestor_carga:pub_processes_address'
    ...
    # Filter messages 
    topic_filter = 'RenovarLibro'.encode('utf-8')
    ...
    while True: 
        ...
        while coordinator_response != 'Access granted':
            req_coordinator_socket.send('Renovacion'.encode('utf-8'))
